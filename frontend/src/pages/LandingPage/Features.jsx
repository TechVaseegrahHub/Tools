...
const statusData = [
    { name: 'AVAIL', value: 65, color: '#000000' },
    { name: 'IN USE', value: 25, color: '#e5e5e5' },
    { name: 'MAINT', value: 10, color: '#ff0000' }
];
        ...
        <section ref={ref} className="py-24 bg-white relative overflow-hidden border-b-4 border-black">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                ...
                <div className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end md:justify-between border-b-4 border-black pb-8">
                    <div>
                        <div className="inline-block bg-black text-white font-mono-tech text-xs px-2 py-1 mb-4">/CORE_SYSTEM</div>
                    ...
                    <p className="mt-6 md:mt-0 max-w-sm font-mono-tech text-sm leading-relaxed text-black font-semibold">
                        SAY GOODBYE TO SPREADSHEETS. MONITOR, MANAGE, AND ANALYZE YOUR TOOL INVENTORY WITH RAW, UNFILTERED DATA.
                    </p>
                </div>
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-start mb-32 relative">
                    ...
                    <div className="lg:sticky lg:top-32 mb-16 lg:mb-0 space-y-8">
                        ...
                        <h3 className="text-3xl md:text-4xl font-black uppercase" style={{ fontFamily: 'Syncopate' }}>REAL-TIME<br />ANALYTICS</h3>
                        <p className="font-mono-tech text-lg leading-relaxed border-l-4 border-black pl-4">
                            Get instant visibility into tool flow across your organization. Spot trends and ensure you always have enough equipment.
                        </p>
                        <ul className="space-y-4 pt-4">
                            {['LIVE IN/OUT METRICS', 'PREDICTIVE ALERTS', 'RAW DATA EXPORT'].map((text, i) => (
                    ...
                    >
                        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 sm:gap-0 mb-4 sm:mb-6 p-2 sm:p-4 border-b-2 border-black bg-gray-50">
                            <h4 className="font-mono-tech font-bold uppercase tracking-widest">/WEEKLY_FLOW/</h4>
                        ...
                        <div className="h-72 w-full pr-4 pb-4">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={usageData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                    ...
                                    <Area type="monotone" dataKey="checkouts" name="OUT" stroke="#000" strokeWidth={4} fill="#000" fillOpacity={0.1} animationDuration={1000} />
                                    <Area type="monotone" dataKey="checkins" name="IN" stroke="#ff0000" strokeWidth={3} fill="#ff0000" fillOpacity={0.1} animationDuration={1200} />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </motion.div>
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-start relative pb-20">
                    ...
                    >
                        <div className="w-full border-b-2 border-black p-2 sm:p-4 bg-gray-50 flex justify-between">
                            <span className="font-mono-tech font-bold uppercase text-xs">/STATUS_DIST/</span>
                    ...
                    <div className="order-1 lg:order-2 lg:sticky lg:top-32 mb-16 lg:mb-0 space-y-8">
                        ...
                        <h3 className="text-3xl md:text-4xl font-black uppercase" style={{ fontFamily: 'Syncopate' }}>ROLE<br />HIERARCHY</h3>
                        <p className="font-mono-tech text-lg leading-relaxed border-l-4 border-black pl-4">
                            Keep your team organized with strict access controls. SuperAdmins, Admins, Managers, and Employees.
                        </p>
                        <div className="grid grid-cols-2 gap-4 pt-4">
                            {['SECURE PROVISIONING', 'ROLE VIEWS', 'AUDIT LOGS', 'PERMISSIONS'].map((text, i) => (
