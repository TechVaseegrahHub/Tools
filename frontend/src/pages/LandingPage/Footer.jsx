                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 border-b-4 border-black pb-16">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-sm font-bold max-w-sm mb-8 leading-relaxed">
                            ...
                            BUILT FOR RAW PERFORMANCE AND ABSOLUTE CONTROL.
                        </p>
                    ...
                    {/* Links 1 */}
                    <div>
                        <h3 className="text-sm font-black uppercase text-gray-500 mb-6 tracking-widest border-b-2 border-gray-200 pb-2 inline-block">/PROTOCOL/</h3>
                        <ul className="space-y-4 font-bold text-sm">
                            <li><a href="#" className="hover:bg-black hover:text-white px-1 transition-colors uppercase">FEATURES_MATRIX.exe</a></li>
                            <li><a href="#" className="hover:bg-black hover:text-white px-1 transition-colors uppercase">PRICING_TIERS.sys</a></li>
                            <li><Link to="/register-org" className="text-[#ff0000] hover:bg-[#ff0000] hover:text-white px-1 transition-colors uppercase">INIT_STARTUP()</Link></li>
                        </ul>
                    </div>

                    {/* Links 2 */}
                    <div>
                        <h3 className="text-sm font-black uppercase text-gray-500 mb-6 tracking-widest border-b-2 border-gray-200 pb-2 inline-block">/TERMS/</h3>
                        <ul className="space-y-4 font-bold text-sm">
                            <li><a href="#" className="hover:bg-black hover:text-white px-1 transition-colors uppercase">PRIVACY_POLICY</a></li>
                            <li><a href="#" className="hover:bg-black hover:text-white px-1 transition-colors uppercase">USER_AGREEMENT</a></li>
                        </ul>
                    </div>
                </div>

                <div className="pt-8 flex flex-col md:flex-row items-center justify-between">
                    <p className="text-xs font-bold uppercase text-gray-500 mb-4 md:mb-0">
